...
#ye <- c(83577, 84114, 87124, 87544, 86937, 88057, 88944, 87544, 85771, 84931, 85141, 85117, 83274) # Hiper par??metros agregados
ye <- c(84231, 83251, 84557, 85584, 84767, 85817, 87077, 87217, 85677, 81921, 80334, 82551, 82947) # Hiper par??metros agregados
...
plot(x, ya_miles, type = "o", col = "blue", lwd = 2,
     ...
     ylim = c(76, max(ya_miles, yb_miles, yc_miles, yd_miles, ye_miles)), # Ajustar el eje y
     pch = 16, cex = 1.2)

# A??adir la segunda, tercera, cuarta y quinta serie de datos
...
lines(x, ye_miles, type = "o", col = "orange", lwd = 2, pch = 16)

# A??adir una leyenda
legend("topleft", legend = c("1 Semilla Propuesta", "Bayesian Parametros", "2 Semilla Propuesta", "2 Semilla Bayesian", "Hiper Parametros Agregados"), 
       col = c("blue", "red", "green", "purple", "orange"), lty = 1, lwd = 2, pch = 16)
...
lines(x, yd_miles, type = "o", col = "purple", lwd = 2, pch = 16)
lines(x, ye_miles, type = "o", col = "orange", lwd = 2, pch = 16)
legend("topright", legend = c("1 Semilla Propuesta", "Bayesian Parametros", "2 Semilla Propuesta", "2 Semilla Bayesian", "Hiper Parametros Agregados"), 
       col = c("blue", "red", "green", "purple", "orange"), lty = 1, lwd = 2, pch = 16)
dev.off()
