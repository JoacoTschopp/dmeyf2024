...
Vmaxdepth = UInt[4, 5, 7, 10]  # Profundidad máxima del árbol
Vmin_samples_split = UInt[200, 400, 600, 800, 1000]  # Mínimo de muestras para dividir un nodo
Vmin_samples_leaf = UInt[10, 20, 30]  # Mínimo de muestras por hoja
Vmin_purity_increase = Float64[-1, -0.1, 0.0, 0.01]  # Mínimo incremento de pureza para realizar una división
