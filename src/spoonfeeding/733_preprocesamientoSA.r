...
PARAM$trainingstrategy$training <- c(202103)#202101, 202102 
...
#DEJO SOLO LO QUE ESTA DENTRO DE LAS 100 PRIMEROS ATRIBUTOS IMPORTANTES
...
#LAGS EXISTEN 33 IMPORNTATES DENTRO DE LOS PRIMEROS 100
...
#DELTA HAY 12 importantes entre los priemros 100
