...
PARAM$experimento_bayesiana <- "HT7240SA_11.1"

PARAM$experimento <- "KA7250SA11.1"
...
dataset <- fread(paste0(PARAM$experimento_data,"/datasetSA_11.1.csv.gz"))
