...
#2.A  "deflacion"      = drift_deflacion(campos_monetarios),
#2.B  "dolar_blue"     = drift_dolarblue(campos_monetarios),
#2.C  "dolar_oficial"  = drift_dolaroficial(campos_monetarios),
#2.D  "UVA"            = drift_UVA(campos_monetarios),
#2.E  "estandarizar"   = drift_estandarizar(campos_monetarios)


PARAM$driftingcorreccion <- "dolar_oficial" #"ninguno"
