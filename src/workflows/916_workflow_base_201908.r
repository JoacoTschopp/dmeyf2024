...
TS_strategy_base6 <- function( pinputexps )
{
  ...
  param_local$future <- c(201908)

  param_local$final_train$undersampling <- 0.2
  param_local$final_train$clase_minoritaria <- c( "BAJA+1", "BAJA+2")
  param_local$final_train$training <- c( 201907, 201906, 201905 )
  
  param_local$train$training <- c(201905,201903,201903)
  param_local$train$validation <- c(201906)
  param_local$train$testing <- c(201907)
...
wf_Exp_stacking_w201908 <- function( pnombrewf )
{
