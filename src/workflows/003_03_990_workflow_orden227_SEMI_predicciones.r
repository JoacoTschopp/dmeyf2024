...
envg$EXPENV$exp_dir <- "~/buckets/b1/expwK03_predicciones/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flowK03_predicciones/"
...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$train$training <- c(
    202105, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 
...
wf_SEMI_K03_SEMI100_mejorado <- function( pnombrewf )
{
  param_local <- exp_wf_init( pnombrewf ) # linea fija

  # Etapa especificacion dataset de la Segunda Competencia Kaggle
  DT_incorporar_dataset( "~/buckets/b1/datasets/competencia_04_ct.csv.gz")
