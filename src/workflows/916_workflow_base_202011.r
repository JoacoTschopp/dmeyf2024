...
TS_strategy_base6 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c( 202009, 202010, 202008, 202007, 202006, 202005 )
  
  param_local$train$training <- c(202008,202007,202006,202005,202001, 201912)
...
wf_Exp_stacking_w202011 <- function( pnombrewf )
{
