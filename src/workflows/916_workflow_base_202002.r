...
TS_strategy_base6 <- function( pinputexps )
{
  ...
  param_local$future <- c(202002)

  param_local$final_train$undersampling <- 0.2
  param_local$final_train$clase_minoritaria <- c( "BAJA+1", "BAJA+2")
  param_local$final_train$training <- c( 202001, 201911, 201912 )
  
  param_local$train$training <- c(201910,201911,201909)
...
wf_Exp_stacking_w202002 <- function( pnombrewf )
{
