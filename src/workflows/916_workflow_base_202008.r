...
TS_strategy_base6 <- function( pinputexps )
{
  ...
  param_local$future <- c(202008)

  param_local$final_train$undersampling <- 0.2
  param_local$final_train$clase_minoritaria <- c( "BAJA+1", "BAJA+2")
  param_local$final_train$training <- c( 202007, 202005, 202006 )
  
  param_local$train$training <- c(202004,202003,202005)
...
wf_Exp_stacking_w202008 <- function( pnombrewf )
{
