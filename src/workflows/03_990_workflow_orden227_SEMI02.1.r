...
envg$EXPENV$exp_dir <- "~/buckets/b1/expwK03/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flowK03/"
...
FErf_attributes_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$train$training <- c( 202015, 202106, 202107)
...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(
    ...
    202005, 2 202002, 202001,
    201912, 201911,
    # 201910 Excluyo por variables rotas02004, 202003,
...
wf_SEMI_K03_02_1 <- function( pnombrewf )
{
