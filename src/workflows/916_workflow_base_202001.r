...
TS_strategy_base6 <- function( pinputexps )
{
  ...
  param_local$future <- c(202001)

  param_local$final_train$undersampling <- 0.2
  param_local$final_train$clase_minoritaria <- c( "BAJA+1", "BAJA+2")
  param_local$final_train$training <- c( 201910, 201911, 201912 )
  
  param_local$train$training <- c(201909,201908,201907)
...
wf_Exp_stacking_w202001 <- function( pnombrewf )
{
