...
TS_strategy_base6 <- function( pinputexps )
{
  ...
  param_local$future <- c(201911)

  param_local$final_train$undersampling <- 0.2
  param_local$final_train$clase_minoritaria <- c( "BAJA+1", "BAJA+2")
  param_local$final_train$training <- c( 201910, 201908, 201909 )
  
  param_local$train$training <- c(201906,201908,201907)
...
wf_Exp_stacking_w201911 <- function( pnombrewf )
{
