...
TS_strategy_base6 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(201905, 201904, 201903)
  
  param_local$train$training <- c(201904, 201903, 201902)
  param_local$train$validation <- c(201905)
...
#w4.1:param_local$final_train$training <- c(202104, 202103, 202102)
#     param_local$train$training <- c(202102, 202101, 202012)
#     param_local$train$undersampling <- 0.25
#sin Canaritos ni RF
#No es el mismo dado que saque variables con Concept-Drifting tambien apra sacarnos la duda de la ganancia.
...
#w7.1:param_local$final_train$training <- c(202104, 202004, 201904)
#     param_local$train$training <- c(202102, 202002, 201902)
#     param_local$train$undersampling <- 0.20

#w7.1:param_local$final_train$training <- c(202005, 202004, 202003)
#     param_local$train$training <- c(202004, 202003, 202002)
#  param_local$train$validation <- c(202005)
#  param_local$train$testing <- c(202006)
#     param_local$train$undersampling <- 0.20

#w8.1:param_local$final_train$training <- c(202005, 202004, 202003)
#     param_local$train$training <- c(202004, 202003, 202002)
#  param_local$train$validation <- c(202005)
#  param_local$train$testing <- c(202006)
#     param_local$train$undersampling <- 0.20

#w9.1:param_local$final_train$training <- c(201905, 201904, 201903)
#     param_local$train$training <- c(201904, 201903, 201902)
#     param_local$train$validation <- c(201905)
#     param_local$train$testing <- c(201904)
#     param_local$train$undersampling <- 0.20
...
wf_Exp_stacking_w9.1 <- function( pnombrewf )
{
